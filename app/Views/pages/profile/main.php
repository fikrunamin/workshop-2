            ...
            <div class="mt-5">
                <div class="grid grid-cols-1 px-5 gap-y-5">
                    <div class="grid grid-cols-1">
                        ...
                        <div>
                            <div class="bg-blue-500 rounded-lg py-5 px-10 grid grid-cols-4 gap-x-5">
                                <div>
                                ...
                                <div class="col-span-full flex justify-end items-center mt-5">
                                    <button type="button" name="profile_information" onclick="update_profile(this)" class="text-center bg-white text-blue-500 shadow-md font-semibold py-2 px-5 rounded-lg">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1">
                        ...
                        <div class="bg-blue-500 rounded-lg py-5 px-10 grid grid-cols-4 gap-x-5">
                            ...
                            <div class="col-span-full flex justify-end items-center mt-5">
                                <button type="submit" name="update_email_and_password" onclick="update_profile(this)" class="text-center bg-white text-blue-500 shadow-md font-semibold py-2 px-5 rounded-lg">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
