<div class="flex flex-col items-center justify-center bg-blue-500 px-5 py-10">
    <div class="grid grid-cols-1 mb-6 flex justify-center">
        <div class="flex justify-center mb-10">
            <div class="text-blue-500 shadow-lg bg-white rounded-full h-48 w-48 flex items-center justify-center">
                <svg version="1.1" id="Capa_1" width="8rem" height="8rem" fill="#3f83f8" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                    <g>
                        <g>
        ...
        <div class="flex justify-center text-center mb-10">
            <div class="w-full">
                ...
                <p class="break-words text-white font-thin">To start consultation, please press button below.</p>
            </div>
        </div>

        <div class="flex justify-center text-center">
            <button class="w-full max-w-full mx-10 bg-white rounded-full shadow-md p-3 font-bold text-blue-500" onclick="start_consultation()">
                START CONSULTATION
            </button>
        </div>
    </div>
