<div id="chat_section" class="grid grid-cols-1 flex flex-wrap content-between h-screen max-h-screen overflow-y-auto">
    ...
    <div class="grid grid-cols-1 flex-1">
        ...
        <div class="p-5 sticky bottom-0 bg-white w-full">
            <div class="relative">
                <button class="inline-flex items-center justify-center absolute right-0 top-0 h-full w-10 text-gray-400" onclick="send_message(this)">
