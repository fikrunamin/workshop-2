...
<div>
    <form action="<?= route_to('register') ?>" method="post">
        ...
        <div class="max-w-xl grid grid-cols-1 gap-y-5" style="width: 36rem;">
            <div class="grid grid-cols-4 px-16 py-10 bg-blue-500 rounded-3xl gap-x-5 gap-y-2">
                <div class="col-span-full grid grid-cols-1 flex justify-center text-white gap-y-2 pb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-center w-full">CREATE ACCOUNT</h2>
                    </div>
                    <div>
                        <p class="text-md font-thin text-center w-full">We're so excited. You'll be the one of our lovely members.</p>
                    </div>
                </div>
                <div>
                    <?= view('auth/components/select', ['field' => 'Prefix', 'options' => ['Mr.', 'Mrs.'], 'icon' => 'keyboard_arrow_down']); ?>
                </div>
                <div class="col-span-3">
                    <?= view('auth/components/input', ['field' => 'Fullname', 'type' => 'text', 'icon' => '']); ?>
                </div>
                <div class="col-span-2">
                    <?= view('auth/components/input', ['field' => 'Birthdate', 'type' => 'date', 'icon' => 'date_range']); ?>
                </div>
                <div class="col-span-2">
                    <?= view('auth/components/input', ['field' => 'Occupation', 'type' => 'text', 'icon' => '']); ?>
                </div>
