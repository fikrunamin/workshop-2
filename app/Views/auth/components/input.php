<div class="grid grid-cols-1 gap-y-2 relative">
    ...
    <div class="relative">
        <input type="<?= $type; ?>" name="<?= $name ?? strtolower($field); ?>" id="<?= $name ?? strtolower($field); ?>" placeholder="<?= $field; ?>" value="<?= $value ?? ''; ?>" class="rounded-lg py-2 pl-5 pr-10 focus:ring focus:ring-blue-300 w-full outline-none duration-200">
